...
def mainwindow():
    window = tk.Tk()
    window.geometry("1250x410")
    window.title("Simple_WebScraper -AdamCM")
    window.resizable(False, False)
    frame1 =Frame(window, width = 318, height = 362, bg = "light cyan")
    frame1.place(x= 10, y  =25) 
#################################################################################################  
    banner = Label(window, text = 'Welcome to Newegg.com webscrape', width = 171, background = 'LightSkyBlue1')
    banner.place(x= 10, y = 2)  

    brandlistbox = Listbox( window, width = 21, height =21, bg = "LightBlue1", justify = LEFT, selectmode = EXTENDED )
    brandlistbox.place(x = 337, y = 50)
    #scroll1 = Scrollbar(brandlistbox, command = brandlistbox.yview)
    
    pricelistbox = Listbox( window, width = 20, height =21, bg = "LightBlue1" , justify = CENTER, selectmode = EXTENDED )
    pricelistbox.place(x = 460, y = 50)
    #scroll2 = Scrollbar(window, command = pricelistbox.yview)
    
    savelistbox = Listbox( window, width = 20, height = 21, bg = "LightBlue1", justify = CENTER , selectmode = EXTENDED )
    savelistbox.place(x = 580, y = 50)
    #scroll3 = Scrollbar(window, command = savelistbox.yview)
    
    Listbox4 = Listbox(window, width =60, height = 21, bg = "LightBlue1", justify = LEFT, selectmode = EXTENDED  )
    Listbox4.place(x = 702, y = 50)
    hyperlink = Listbox(window, width =25, height = 21, bg = "LightBlue1", justify = LEFT, selectmode = EXTENDED  )
...
###########################################################################################
    ...
    filenamehere.place(x = 45, y = 220)
    filenamehere1 = Label(frame1, text = "Opens", width = 10)
    filenamehere1.place(x = 195, y = 220)
